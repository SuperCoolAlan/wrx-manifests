...
TRAPS = [
 ...
 ((7,),   "   1. BY from the fuel pump relay, between R1 pin 7 and R166 - now drives"),
 ((7,),   "      the new relay coil. R166, R167 and R122 past it are all dead."),
 ...
 ((7,),   "USE THE STi FUEL PUMP DIAGRAM E/G(ST)-01 (WI-108), NOT THE TURBO E/G(TB)-01"),
 ((7,),   "   (WI-82). They look nearly identical, but the STi routing inserts the"),
 ((7,),   "   R166/R167 harness pair between R1 and R122 and the turbo one does not."),
