...
TRAPS = [
 ...
 ((7,),   "THE FACTORY FUEL PUMP CONTROL MODULE IS STILL FITTED AND STILL PLUGGED IN,"),
 ((7,),   "   BUT IT IS DEAD. Its 12V feed was spliced away to trigger a relay under the"),
 ((7,),   "   rear seat that hardwires the pump. The module does nothing. DO NOT"),
 ((7,),   "   DIAGNOSE IT and do not conclude the pump circuit is faulty because it"),
 ((7,),   "   reads dead - that is the intended state. See TAB 7a."),
