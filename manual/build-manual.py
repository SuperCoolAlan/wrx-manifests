...
TRAPS = [
 ...
 ((7,),   "FUEL PUMP IS HARDWIRED, BUT THE FACTORY FUEL PUMP CONTROL MODULE (R122) IS"),
 ((7,),   "   STILL FITTED, STILL PLUGGED IN AND STILL IN THE SIGNAL PATH. The wire that"),
 ((7,),   "   originally fed the pump at R58 pin 1 was CUT and now triggers a 40A relay"),
 ((7,),   "   under the rear seat. IF THE FPCM FAILS, THE RELAY NEVER CLOSES AND THE PUMP"),
 ((7,),   "   NEVER RUNS. It is not decorative - do not remove it. See TAB 7a."),
 ((7,),   "Fuel pump feed traces BOr at R15 pin 8, becomes BY across R57, to R58 pin 1."),
